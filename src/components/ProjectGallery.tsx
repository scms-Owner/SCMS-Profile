        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredItems.map((item, index) => (
            ...
            >
              ...
              {item.image ? <img src={item.image} alt={item.title} className="absolute inset-0 h-full w-full object-cover object-center opacity-80 group-hover:opacity-100 transition-opacity" /> : null}
              <div className="absolute inset-0 bg-gradient-to-t from-[#0a0c12]/95 via-[#11131a]/35 to-transparent pointer-events-none"></div>
